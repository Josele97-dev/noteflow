...
export default function NoteCard({ note, onPress, onDelete, index = 0 }: Props) {
  ...
  return (
    <Animated.View
      ...
      <Swipeable enabled={!removing} friction={1.8} rightThreshold={30} overshootRight={false}
...
const styles = StyleSheet.create({
  card: { borderRadius: 16, padding: 14, marginHorizontal: 16, marginVertical: 8, borderWidth: 1, shadowColor: '#000', shadowOpacity: 0.06, shadowRadius: 10, shadowOffset: { width: 0, height: 4 }, elevation: 2 },
